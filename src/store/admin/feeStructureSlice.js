...
// Add Fee Structure
export const addFeeStructure = createAsyncThunk('admin/create-fee-structure', async (data, thunkAPI) => {
  try {
...
// export const fetchDeletedFeeStructures = createAsyncThunk('admin/delete-fee-structure', async (queryParams = '', thunkAPI) => {
//   try {
//     const response = await getData(`/admin/delete-fee-structure${queryParams}`)
//     return response
//   } catch (error) {
//     return thunkAPI.rejectWithValue(error.message)
//   }
...
export const updateFeeStructure = createAsyncThunk('admin/update-fee-structure/', async ({ id, ...rest }, thunkAPI) => {
  try {
    const uuid = id;
