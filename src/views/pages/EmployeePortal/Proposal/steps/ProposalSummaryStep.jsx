...
//     employee_approval:1
//     }
//       dispatch(updateProposal({uuid:data.uuid,data:newdata})).then((res)=>{
//         if (res.payload.success) {
//            showToast('success', 'Proposal Send For Approval.');
//           dispatch(getProposalByUUID(data.uuid)).then((data)=>{
...
//       }
//        {data?.employee_approval == 0 && user.role=="employee" && <CButton className="custom-button"   onClick={HandleSendApproval}>
//                            Send To Approval
//                     </CButton> }

//          {data?.approval_status == 1  && <CButton className="custom-button m-2"   onClick={HandleSendToClient}>
//                      Send To Client
//               </CButton> } 
...
//       {data.approval_status == 2 && <div className='my-2'>
