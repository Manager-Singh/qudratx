...
//  import PdfSettings from './Tabs/PdfSettings'
...
const Setting = () => {
  ...
  const [form, setForm] = useState({
    ...
    phone: '',
    address: [
      { type: '', line1: '', city: '', state: '', country: '', postal_code: '' },
    ],
    terms_and_conditions: '',
    bank_details: {
      bank_title: '',
        ...
        <CCol md={12}>
          <CCard>
            ...
            <CCardBody>
              <CNav variant="tabs" role="tablist">
                <CNavItem>
                  <CNavLink
                    ...
                    className={classNames({ active: activeKey === 1 })}
                  >
                    Company Info
                  </CNavLink>
                </CNavItem>
                <CNavItem>
                  <CNavLink
                    ...
                    className={classNames({ active: activeKey === 2 })}
                  >
                    PDF Settings
                  </CNavLink>
                </CNavItem>
              ...
              <CTabContent>
                <CTabPane role="tabpanel" aria-labelledby="company-tab" visible={activeKey === 1}>
                  <CompanyInfo
                    form={form}
                ...
                <CTabPane role="tabpanel" aria-labelledby="pdf-tab" visible={activeKey === 2}>
                  <PdfSettings />
                </CTabPane>
              </CTabContent>
            </CCardBody>
